...
Usage: STLe ([OPTIONS] SIGNAL_FILE)+
Options:
...
-pi    Print input signal to stderr in debuf format (this may print a lot).
-pc    Print performance counters to stderr.
-pm    Print some extra messages for readability.
-de 0|1    Default 1. Whether to evaluate the formula.
-db 0|1    Default 0. Read whole signal file to memory (speeds up reading a bit).
